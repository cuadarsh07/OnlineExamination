...
public class MainCaller {
	...
	public static void main(String[] args) throws ParseException {
		...
		Address add1=new Address(910, "Kalpana Hostel", 140307, 999, "Punjab", "Harayana", crdate);
		Address add2=new Address(911, "Manpur patawatoli", 823003, 123, "Bihar", "Gaya", crdate);
		Address add3=new Address(912, "Patna Bihar", 823005, 123, "Bihar", "Gaya", crdate);
		addList.add(add1);
		addList.add(add2);
		addList.add(add3);
		...
		Student stu1=new Student(5003, "Jitendra",24, "Surabhi@gmail.com", 8911229819L, dob, crdate, addList);
